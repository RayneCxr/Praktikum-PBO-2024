...
abstract class Barang {
    ...
    public Barang(Integer kodeBarang, String namaBarang, int stokAwal, int barangMasuk, int barangKeluar, String keterangan) {
        this.nomor = counter++;
...
class BarangHabisPakai extends Barang {
    private static ArrayList<BarangHabisPakai> BarangHabisPakaiList = new ArrayList<>();

    public BarangHabisPakai(int kodeBarang, String namaBarang, int stokAwal, int barangMasuk, int barangKeluar, String keterangan) {
...
class BarangTidakHabisPakai extends Barang {
    private static ArrayList<BarangTidakHabisPakai> BarangTidakHabisPakaiList = new ArrayList<>();

    public BarangTidakHabisPakai(int kodeBarang, String namaBarang, int stokAwal, int barangMasuk, int barangKeluar, String keterangan) {
        super(kodeBarang, namaBarang, stokAwal, barangMasuk, barangKeluar, keterangan);
...
public class Main {
    ...
    private static void lihatSemuaBarangTidakHabisPakai() {        ArrayList<BarangTidakHabisPakai> BarangTidakHabisPakaiList = BarangTidakHabisPakai.getBarangTidakHabisPakaiList();
